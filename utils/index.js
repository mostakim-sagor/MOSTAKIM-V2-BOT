...
// Stub for @mostakimpr0ject/assets (unavailable package)
const assetStub = {
    font: { loaded: false, load: async () => {}, get: () => null },
    image: { loaded: false, load: async () => {}, get: () => null },
    data: { loaded: false, load: async () => {}, get: () => null }
};
